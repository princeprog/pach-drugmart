    ...
    return (
        <div className="home px-16">
            <div className="tagline flex items-center font-mono text-3xl bg-[url('/images/fortagline.jpg')] bg-cover bg-center h-[35rem] mt-8 shadow-[0px_4px_6px_rgba(0,0,0,0.1),0px_1px_10px_rgba(0,0,0,0.1)] relative rounded-xl">
                ...
                <div>
                    <h1 className="text-white z-10 relative ml-4">"Your source</h1>
                    <h1 className="text-white z-10 relative ml-16">of cost </h1>
                    <h1 className="text-white z-10 relative ml-8">effective healthcare"</h1>
                </div>
            </div>
