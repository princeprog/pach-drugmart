            ...
            <div className="bg-gray-100 p-8 rounded-md">
                ...
                <div className="mt-8 flex space-x-8">
                    <div className="w-fit p-4 flex flex-col justify-between">
                        ...
                        <button className="font-medium mt-8 w-full p-2.5 rounded-md bg-[#5CB338] text-white cursor-pointer" onClick={
                            () => navigate("/register")
                    ...
                    <div className="w-fit p-4">
                        ...
                        <p className="mt-4 text-[#5CB338] underline cursor-pointer">Forgot password?</p>
                        <button className="font-medium mt-8 w-full p-2.5 rounded-md bg-[#5CB338] text-white">Login</button>
                    </div>
                </div>
            </div>
        </div>
